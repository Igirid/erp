...
//   },
// ]);
// const paymentCategory = ref(null);
const { paymentCategory, paymentCategories } = useCategory();
      ...
      >
        <div class="p-8 text-gray-600">
          <div class="flex justify-between items-center mb-4">
            <h2 class="text-lg font-semibold">Create Payment</h2>
            <LucideX
          ...
          <UiUpload :imagePlaceholder="'/payment-placeholder.png'"></UiUpload>
          ...
          <div class="grid grid-cols-2 gap-6 mt-4">
            <div>
              ...
              <UiSelectField
                :displayIcon="`/payment-placeholder.png`"
                v-model="paymentBank"
